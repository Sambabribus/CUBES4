...
VALUES
    ...
    ('Saint Mont Tradition', 'Vin rouge', 'Plaimont Producteurs', '2021', 6.00, 9.90, 80, 'Vin rouge charpenté typique du Sud-Ouest.'),
    ('Pacherenc Doux', 'Vin blanc doux', 'Plaimont Producteurs', '2020', 8.00, 14.90, 60, 'Vin blanc moelleux aux arômes exotiques.'),
    ('Haut-Marin Colombard', 'Vin blanc sec', 'Domaine Haut-Marin', '2022', 4.50, 7.50, 100, 'Vin blanc sec léger et rafraîchissant.'),
    ('Vin Rosé Prestige', 'Vin rosé', 'Domaine Haut-Marin', '2022', 5.00, 8.00, 90, 'Vin rosé fruité parfait pour l\'été.'),
    ('Floc de Gascogne', 'Floc de Gascogne', 'Domaine Saint-Martin', '2021', 7.00, 11.90, 70, 'Apéritif doux et aromatique.'),
    ('Vin Blanc Moelleux', 'Vin blanc moelleux', 'Domaine Saint-Martin', '2022', 6.50, 10.50, 75, 'Vin moelleux aux notes de fruits confits.'),
    ('Madiran Prestige', 'Vin rouge', 'Plaimont Producteurs', '2020', 9.00, 15.00, 40, 'Vin rouge puissant et complexe.'),
    ('Armagnac Hors d\'Age', 'Armagnac', 'Domaine de Magnaut', '2008', 35.00, 55.00, 25, 'Armagnac haut de gamme vieilli 15 ans.'),
    ('Vin Rosé Tradition', 'Vin rosé', 'Domaine de Pellehaut', '2022', 4.80, 7.90, 110, 'Vin rosé gourmand aux notes de fruits rouges.'),
    ('Vin Blanc Sec', 'Vin blanc sec', 'Domaine de Pellehaut', '2021', 5.50, 8.50, 95, 'Vin blanc vif et équilibré.'),
    ('Colombard-Gros Manseng', 'Vin blanc fruité', 'Domaine Uby', '2022', 6.20, 9.90, 100, 'Assemblage fruité et expressif.'),
    ('Côtes de Gascogne Rouge', 'Vin rouge', 'Domaine de Maubet', '2021', 5.00, 8.50, 85, 'Vin rouge souple et agréable.'),
    ('Vin Blanc Sec Tradition', 'Vin blanc sec', 'Domaine des Cassagnoles', '2022', 5.00, 7.50, 120, 'Vin blanc frais aux notes d\'agrumes.'),
    ('Colombard-Sauvignon', 'Vin blanc sec', 'Domaine de l\'Herré', '2022', 6.00, 9.50, 90, 'Vin blanc au nez expressif et floral.'),
    ('Vin Rosé Signature', 'Vin rosé', 'Domaine Chiroulet', '2021', 5.50, 8.90, 75, 'Vin rosé frais et fruité.'),
    ('Vin Bio Rouge', 'Vin rouge', 'Les Vignobles Fontan', '2021', 7.00, 12.00, 80, 'Vin rouge biologique certifié AB.'),
    ('Madiran Château Montus', 'Madiran', 'Les Vignobles Brumont', '2018', 15.00, 25.00, 30, 'Vin rouge puissant et complexe.'),
    ('Pacherenc de Vic-Bilh', 'Vin blanc doux', 'Les Vignobles Brumont', '2019', 12.00, 19.00, 40, 'Vin blanc doux et élégant.'),
    ('Tariquet Chardonnay', 'Vin blanc sec', 'Domaine Tariquet', '2022', 6.50, 9.90, 100, 'Chardonnay frais aux notes de fruits tropicaux.'),
    ('Tariquet Réserve', 'Armagnac', 'Domaine Tariquet', '2016', 25.00, 40.00, 60, 'Armagnac élégant vieilli en fût de chêne.'),
    ('Madiran Vieilles Vignes', 'Vin rouge', 'Plaimont Producteurs', '2019', 10.00, 16.90, 50, 'Vin rouge complexe aux tannins soyeux.'),
    ('Saint Mont Blanc Sec', 'Vin blanc sec', 'Plaimont Producteurs', '2021', 5.50, 8.50, 120, 'Vin blanc frais aux notes d\'agrumes.'),
    ('Vin Blanc Moelleux Signature', 'Vin blanc moelleux', 'Domaine Haut-Marin', '2021', 6.00, 10.00, 80, 'Vin moelleux doux et équilibré.'),
    ('Vin Rosé Floral', 'Vin rosé', 'Domaine Haut-Marin', '2022', 4.90, 7.90, 90, 'Vin rosé frais et floral.'),
    ('Floc de Gascogne Rouge', 'Floc de Gascogne', 'Domaine Saint-Martin', '2022', 8.50, 13.50, 70, 'Apéritif doux à base de vin rouge et armagnac.'),
    ('Côtes de Gascogne Blanc', 'Vin blanc sec', 'Domaine Saint-Martin', '2022', 5.90, 9.50, 85, 'Vin blanc sec équilibré et aromatique.'),
    ('Magnaut Gros Manseng', 'Vin blanc fruité', 'Domaine de Magnaut', '2022', 7.00, 11.50, 60, 'Vin blanc fruité et rafraîchissant.'),
    ('Armagnac XO', 'Armagnac', 'Domaine de Magnaut', '2005', 45.00, 70.00, 30, 'Armagnac prestigieux vieilli 18 ans.'),
    ('Pellehaut Harmonie Rosé', 'Vin rosé', 'Domaine de Pellehaut', '2022', 5.20, 8.20, 110, 'Vin rosé fruité et floral.'),
    ('Pellehaut Chardonnay', 'Vin blanc sec', 'Domaine de Pellehaut', '2021', 6.00, 9.50, 90, 'Vin blanc sec aux notes beurrées.'),
    ('Uby Gros Manseng-Sauvignon', 'Vin blanc fruité', 'Domaine Uby', '2022', 7.20, 10.90, 100, 'Assemblage fruité et expressif.'),
    ('Maubet Rosé Prestige', 'Vin rosé', 'Domaine de Maubet', '2022', 5.00, 8.00, 100, 'Vin rosé frais aux notes de fruits rouges.'),
    ('Cassagnoles Moelleux', 'Vin blanc moelleux', 'Domaine des Cassagnoles', '2021', 6.50, 10.00, 90, 'Vin blanc doux et gourmand.'),
    ('L\'Herré Chardonnay', 'Vin blanc sec', 'Domaine de l\'Herré', '2022', 7.00, 11.50, 85, 'Vin blanc structuré et rond.'),
    ('Chiroulet Rouge Classique', 'Vin rouge', 'Domaine Chiroulet', '2020', 8.00, 12.50, 70, 'Vin rouge aux tanins soyeux.'),
    ('Fontan Bio Rosé', 'Vin bio rosé', 'Les Vignobles Fontan', '2022', 7.50, 12.00, 90, 'Vin rosé biologique frais et fruité.'),

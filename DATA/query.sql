INSERT INTO items (name, alcohol_type, domain_name, millesime, purchase_price, selling_price, stock_quantity, threshold_min, description)
VALUES
    ('Tariquet Classic', 'Vin blanc', 'Domaine Tariquet', '2022', 5.50, 8.90, 120, 10, 'Vin blanc sec frais et fruité.'),
    ('Saint Mont Tradition', 'Vin rouge', 'Plaimont Producteurs', '2021', 6.00, 9.90, 80, 10, 'Vin rouge charpenté typique du Sud-Ouest.'),
    ('Pacherenc Doux', 'Vin blanc', 'Plaimont Producteurs', '2020', 8.00, 14.90, 60, 10, 'Vin blanc moelleux aux arômes exotiques.'),
    ('Haut-Marin Colombard', 'Vin blanc', 'Domaine Haut-Marin', '2022', 4.50, 7.50, 100, 10, 'Vin blanc sec léger et rafraîchissant.'),
    ('Vin Rosé Prestige', 'Vin rosé', 'Domaine Haut-Marin', '2022', 5.00, 8.00, 90, 10, 'Vin rosé fruité parfait pour l\'été.'),
    ('Vin Blanc Moelleux', 'Vin blanc', 'Domaine Saint-Martin', '2022', 6.50, 10.50, 75, 10, 'Vin moelleux aux notes de fruits confits.'),
    ('Madiran Prestige', 'Vin rouge', 'Plaimont Producteurs', '2020', 9.00, 15.00, 40, 10, 'Vin rouge puissant et complexe.'),
    ('Vin Rosé Tradition', 'Vin rosé', 'Domaine de Pellehaut', '2022', 4.80, 7.90, 110, 10, 'Vin rosé gourmand aux notes de fruits rouges.'),
    ('Vin Blanc Sec', 'Vin blanc', 'Domaine de Pellehaut', '2021', 5.50, 8.50, 95, 10, 'Vin blanc vif et équilibré.'),
    ('Colombard-Gros Manseng', 'Vin blanc', 'Domaine Uby', '2022', 6.20, 9.90, 100, 10, 'Assemblage fruité et expressif.'),
    ('Côtes de Gascogne Rouge', 'Vin rouge', 'Domaine de Maubet', '2021', 5.00, 8.50, 85, 10, 'Vin rouge souple et agréable.'),
    ('Vin Blanc Sec Tradition', 'Vin blanc', 'Domaine des Cassagnoles', '2022', 5.00, 7.50, 120, 10, 'Vin blanc frais aux notes d\'agrumes.'),
    ('Colombard-Sauvignon', 'Vin blanc', 'Domaine de l\'Herré', '2022', 6.00, 9.50, 90, 10, 'Vin blanc au nez expressif et floral.'),
    ('Vin Rosé Signature', 'Vin rosé', 'Domaine Chiroulet', '2021', 5.50, 8.90, 75, 10, 'Vin rosé frais et fruité.'),
    ('Vin Bio Rouge', 'Vin rouge', 'Les Vignobles Fontan', '2021', 7.00, 12.00, 80, 10, 'Vin rouge biologique certifié AB.'),
    ('Pacherenc de Vic-Bilh', 'Vin blanc', 'Les Vignobles Brumont', '2019', 12.00, 19.00, 40, 10, 'Vin blanc doux et élégant.'),
    ('Tariquet Chardonnay', 'Vin blanc', 'Domaine Tariquet', '2022', 6.50, 9.90, 100, 10, 'Chardonnay frais aux notes de fruits tropicaux.'),
    ('Madiran Vieilles Vignes', 'Vin rouge', 'Plaimont Producteurs', '2019', 10.00, 16.90, 50, 10, 'Vin rouge complexe aux tannins soyeux.'),
    ('Saint Mont Blanc Sec', 'Vin blanc', 'Plaimont Producteurs', '2021', 5.50, 8.50, 120, 10, 'Vin blanc frais aux notes d\'agrumes.'),
    ('Vin Blanc Moelleux Signature', 'Vin blanc', 'Domaine Haut-Marin', '2021', 6.00, 10.00, 80, 10, 'Vin moelleux doux et équilibré.'),
    ('Vin Rosé Floral', 'Vin rosé', 'Domaine Haut-Marin', '2022', 4.90, 7.90, 90, 10, 'Vin rosé frais et floral.'),
    ('Côtes de Gascogne Blanc', 'Vin blanc', 'Domaine Saint-Martin', '2022', 5.90, 9.50, 85, 10, 'Vin blanc sec équilibré et aromatique.'),
    ('Magnaut Gros Manseng', 'Vin blanc', 'Domaine de Magnaut', '2022', 7.00, 11.50, 60, 10, 'Vin blanc fruité et rafraîchissant.'),
    ('Pellehaut Harmonie Rosé', 'Vin rosé', 'Domaine de Pellehaut', '2022', 5.20, 8.20, 110, 10, 'Vin rosé fruité et floral.'),
    ('Pellehaut Chardonnay', 'Vin blanc', 'Domaine de Pellehaut', '2021', 6.00, 9.50, 90, 10, 'Vin blanc sec aux notes beurrées.'),
    ('Uby Gros Manseng-Sauvignon', 'Vin blanc', 'Domaine Uby', '2022', 7.20, 10.90, 100, 10, 'Assemblage fruité et expressif.'),
    ('Maubet Rosé Prestige', 'Vin rosé', 'Domaine de Maubet', '2022', 5.00, 8.00, 100, 10, 'Vin rosé frais aux notes de fruits rouges.'),
    ('Cassagnoles Moelleux', 'Vin blanc', 'Domaine des Cassagnoles', '2021', 6.50, 10.00, 90, 10, 'Vin blanc doux et gourmand.'),
    ('L\'Herré Chardonnay', 'Vin blanc', 'Domaine de l\'Herré', '2022', 7.00, 11.50, 85, 10, 'Vin blanc structuré et rond.'),
    ('Chiroulet Rouge Classique', 'Vin rouge', 'Domaine Chiroulet', '2020', 8.00, 12.50, 70, 10, 'Vin rouge aux tanins soyeux.'),
    ('Fontan Bio Rosé', 'Vin rosé', 'Les Vignobles Fontan', '2022', 7.50, 12.00, 90, 10, 'Vin rosé biologique frais et fruité.'),
    ('Brumont Blanc Sec', 'Vin blanc ', 'Les Vignobles Brumont', '2021', 14.00, 22.00, 50, 10, 'Vin blanc sec élégant et minéral.');
